class SectionProducts extends HTMLSection {
    ...
    sectionForItems: HTMLElement | null 
    filterBtnMobile: HTMLElement | null 
    closeFilterMobile: HTMLElement | null
    filterDIV: HTMLElement | null
    ...
    constructor(){
        ...
        this.filterItems()
        this.filterBtnMobile?.addEventListener('click', this.showFilterOnMobile.bind(this))
        this.closeFilterMobile?.addEventListener('click', this.hideFilterMobile.bind(this))
        this.closeFilterOnClick()
    }

    // Generate (innerHTML)
    generateProductsHTML(oneItem: ShoppingItem){
    ...
    generateAllProducts(){
        ...
        const filterAllBtn = document.querySelector('.filter-all') as HTMLElement
    ...
    findCategoryInArray = (btn: HTMLElement, className: string, section: HTMLElement, array: ShoppingItem[], category: string, generateHTML: (x: ShoppingItem) => void) => {
